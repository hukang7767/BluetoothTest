...
package com.huaxin.emmp_ard.scan.camera;
...
public final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		Log.d("hebing", "Default preview format: " + previewFormat + '/'
				+ previewFormatString);
		...
		Log.d("hebing", "Screen resolution: " + mScreenResolution);
		// cameraResolution = screenResolution;
		Log.d("hebing", "Camera resolution: " + cameraResolution);
	}
	...
	void setDesiredCameraParameters(Camera camera) {
		...
		Camera.Parameters parameters = camera.getParameters();
		Log.d("hebing", "Setting preview size: " + cameraResolution);
	...
	public static Point getCameraResolution(Camera.Parameters parameters,
		...
		if (previewSizeValueString != null) {
			Log.d("hebing", "preview-size-values parameter: "
